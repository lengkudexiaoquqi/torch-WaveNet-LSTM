...
# AQI", "PM2.5", "PM10", "SO2", "NO2", "O3", "CO", "温度", "压强", "风力", "降水量", "湿度","风向
X_POS=[6,7,9,11]
Y_POS= 6
Window_size=8
filter_size= 40
...
bp = BPNet(input_size=FEATURE,hidden_size=HIDDEN_SIZE, predict_step=1)
...
# torch.save(bpnn,"../Diebold-Mariano-Test-master/muti_factor_predict_value/bpnn/PM2.5.pkl")
# np.save("../Diebold-Mariano-Test-master/muti_factor_predict_value/bpnn/PM2.5.npy",y_pred)
